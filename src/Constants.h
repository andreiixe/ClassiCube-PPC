...
#define GAME_APP_VER "1.3.7rev4-PPC"
...
#else
#define GAME_APP_NAME  "ClassiCube 1.3.7rev4-PPC"
#define GAME_APP_TITLE "ClassiCube 1.3.7rev4-PPC"
#endif
...
#define UPDATES_SERVER  "http://pikaiixe.ddns.net:5090/client"
