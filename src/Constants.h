...
#define GAME_APP_VER "1.3.7rev1-PPC"
...
#else
#define GAME_APP_NAME  "ClassiCube 1.3.7rev1-PPC"
#define GAME_APP_TITLE "ClassiCube 1.3.7rev1-PPC"
#endif
...
#define UPDATES_SERVER  "http://pikaiixe.duckdns.org:5090/client" //custom update check
